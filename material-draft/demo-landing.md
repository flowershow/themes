---
title: Flowershow — Material-inspired preview
description: A bright, structured preview theme for Markdown publishing
layout: plain
showToc: false
showEditLink: false
showComments: false
...
<div class="mat-landing" data-owned-fixture="material-inspired" data-theme-status="preview">
  <section class="relative overflow-hidden hero-placeholder" style="min-height:700px;">
    <div class="relative z-20">
      <header style="min-height:56px;" class="flex items-center">
        <div class="mx-auto w-full max-w-[1220px] px-4 flex items-center gap-3">
          <span class="mat-brand-mark" aria-hidden="true">F</span>
          <span class="text-white font-medium" style="font-size:18px;">Flowershow</span>
          <span class="mat-preview-label">Material-inspired preview</span>
          <div class="flex-1"></div>
          <a class="mat-header-link" href="https://github.com/flowershow/themes">Theme repository</a>
        </div>
      </header>
    ...
    <div class="absolute inset-x-0 z-20" style="bottom:96px;">
      <div class="mx-auto w-full max-w-[1220px] px-4">
        <div style="max-width:600px;">
          <p class="mat-eyebrow">PREVIEW THEME SPECIMEN</p>
          <h1 class="t-h1-hero text-white">A bright, structured home for Markdown</h1>
          <p class="t-body text-white" style="margin:16px 0;">
            Explore a Flowershow theme shaped by Material design ideas: strong hierarchy,
            generous spacing, clear navigation, and comfortable reading across documentation
    ...
    <div class="mat-scroll-cue" aria-hidden="true">↓</div>
  </section>
  ...
  <section style="background:#1e2129;" class="py-24">
    <div class="mx-auto w-full max-w-[1220px] px-4">
      ...
      <div class="review-grid">
        <div class="review-card"><strong>Desktop</strong><span>1280 × 900</span></div>
        <div class="review-card"><strong>Mobile</strong><span>390 × 844</span></div>
        <div class="review-card"><strong>Light</strong><span>reviewed</span></div>
        <div class="review-card"><strong>Dark</strong><span>reviewed</span></div>
      </div>
    </div>
  </section>
    ...
    <div class="mx-auto w-full max-w-[1220px] px-4 inspiration-layout">
      ...
      <div>
        <p class="t-body dark-body">
          This Flowershow preview draws on the clarity, color, and documentation focus of
          <a href="https://squidfunk.github.io/mkdocs-material/">Material for MkDocs</a>,
          an open-source project. The copy, CSS geometry, specimen cards, and gradient on this
          page are Flowershow-owned; no upstream illustration, logo, repository badge, customer
          list, or testimonial is reproduced.
        </p>
        <p class="t-body dark-body" style="margin-top:16px;">
          See the <a href="https://flowershow-themes-preview-rufuspollock.flowershow.me/third-party-notices">third-party notice</a>
          for the retained open-source attribution.
        </p>
      </div>
    </div>
  </section>
  ...
  <footer class="mat-footer py-10">
    <div class="mx-auto w-full max-w-[1220px] px-4 flex items-center justify-between t-small mat-footer-inner">
      <span>Flowershow Material-inspired preview</span>
      <span><a href="https://github.com/flowershow/themes">Source</a> · <a href="https://squidfunk.github.io/mkdocs-material/">Inspiration</a></span>
    </div>
  </footer>
</div>
