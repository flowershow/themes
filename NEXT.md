...
2. Enable and review the currently unavailable search surface, then complete
   the landing-fixture copy, trademark, SVG/icon provenance, and attribution
   review in the [release-readiness record](docs/release-readiness.md),
   replacing anything not cleared for release while keeping Material and
   code.storage visibly marked preview/beta.
