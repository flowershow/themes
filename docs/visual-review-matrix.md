...
Material and Monospace demos. It supplements Rufus's earlier
...
- [Monospace demo](https://monospace-theme-demo-rufuspollock.flowershow.me)
- [Monospace landing](https://monospace-theme-demo-rufuspollock.flowershow.me/landing)
...
Full-page captures of all homepage combinations plus representative kitchen
sink and blog pages were manually inspected. The compact hierarchy, quiet
CSS-authored node/orbit visual, light/dark contrast, mobile reading order and
internal theme surfaces remain coherent. Flowershow's hosted “Built with”
badge remains a platform overlay and appears on internal pages as well; it is
not generated by the homepage.
...
surface. Material remains **Preview** and Monospace is **Official** following
Rufus's explicit 2026-08-21 promotion decision. Search is not reviewable in
these demos and remains tracked in flowershow/flowershow#1370. The
landing-fixture provenance actions are
